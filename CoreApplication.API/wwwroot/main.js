...
var HasRoleDirective = /** @class */ (function () {
    ...
    HasRoleDirective.prototype.ngOnInit = function () {
        ...
        // if user has a role then render the element
...
var AuthGuard = /** @class */ (function () {
     ...
     *
     */
    function AuthGuard(authService, alertifyService, routeService) {
        this.authService = authService;
...
var MemberEditResolver = /** @class */ (function () {
     ...
     *
     */
    function MemberEditResolver(userService, alertify, authService) {
        this.userService = userService;
        this.alertify = alertify;
        this.authService = authService;
    }
    MemberEditResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUser(this.authService.decodedToken.nameid)
            ...
            console.log(_this.authService.decodedToken.nameid);
            _this.alertify.error('Problem retrieving data 3');
            return rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"].of(null);
        });
    };
    MemberEditResolver = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["Injectable"])(),
        __metadata("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_0__["UserService"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_1__["AlertifyService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"]])
    ], MemberEditResolver);
...
var MemberListResolver = /** @class */ (function () {
    ...
    MemberListResolver.prototype.resolve = function (route) {
        ...
        return this.userService.getUsers(this.pageNumber, this.pageSize).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            _this.alertify.error('Problem retrieving data 2');
            _this.router.navigate(['/home']);
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    };
...
var UserManagementComponent = /** @class */ (function () {
    function UserManagementComponent(adminService) {
...
/* harmony import */ var _resolvers_message_resolver__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./_resolvers/message.resolver */ "./src/app/_resolvers/message.resolver.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _resolvers_message_resolver__WEBPACK_IMPORTED_MODULE_32__["MessageResolver"],
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getValues = function () {
        var _this = this;
        this.http.get('http://localhost:8000/api/values').subscribe(function (response) {
            console.log(response);
            _this.values = response;
        });
    };
    HomeComponent.prototype.cancelRegister = function (cancelFlag) {
...
module.exports = "<!-- <div class=\"container\">\n<div class=\"row\">\n<div class=\"btn-group\">\n\n  <button class=\"btn btn-primary\" [(ngModel)]=\"likeParams\" btnRadio=\"Likers\" (click)=\"loadUsers()\">Members Who Like Me</button>\n  <button class=\"btn btn-primary\" [(ngModel)]=\"likeParams\" btnRadio=\"Likees\" (click)=\"loadUsers()\">Members I Liked</button>\n</div>\n\n</div>\n\n<h2>\n  {{likeParams === 'Likers' ? 'Members who like me' : 'Members who I\\'ve  liked'  }} : {{pagination.totalItems}}\n\n\n  </h2>\n\n  <div class=\"row equal\">\n      <div *ngFor=\"let user of users\" class=\"col-lg-2 col-md-3 col-sm-6\">\n         <app-member-card [user]=\"user\"></app-member-card>\n      </div>\n    </div>\n\n    <div class=\"text-center\">\n        <pagination [boundaryLinks]=\"true\" \n                    [totalItems]=\"pagination.totalItems\"\n                    [itemsPerPage]=\"pagination.itemsPerPage\" \n                    (pageChanged)=\"pageChanged($event)\"\n                    [(ngModel)]= \"pagination.currentPage\" \n                    class=\"pagination-sm\"\n                  previousText=\"&lsaquo;\" nextText=\"&rsaquo;\" firstText=\"&laquo;\" lastText=\"&raquo;\">\n       \n          </pagination>\n      </div>  \n</div> -->\n<div class=\"text-center mt-3\">\n  <h2>{{likeParams === 'Likers' ? 'Members who like me' : 'Members who I\\'ve Liked'}} : {{pagination.totalItems}}</h2>\n</div>\n\n<div class=\"container mt-3\">\n\n<div class=\"row\">\n  <div class=\"btn-group\">\n    <button class=\"btn btn-primary\" [(ngModel)]=\"likeParams\" btnRadio=\"Likers\" (click)=\"loadUsers()\">Members who like me</button>\n    <button class=\"btn btn-primary\" [(ngModel)]=\"likeParams\" btnRadio=\"Likees\" (click)=\"loadUsers()\">Members who I like</button>\n  </div>\n</div>\n\n<br>\n\n<div class=\"row\">\n  <div *ngFor=\"let user of users\" class=\"col-sm-6 col-md-4 col-lg-4 col-xl-2\">\n    <app-member-card [user]=\"user\"></app-member-card>\n  </div>\n</div>\n\n\n\n</div>\n\n<div class=\"d-flex justify-content-center\">\n<pagination [boundaryLinks]=\"true\" [totalItems]=\"pagination.totalItems\" [itemsPerPage]=\"pagination.itemsPerPage\" [(ngModel)]=\"pagination.currentPage\"\n  (pageChanged)=\"pageChanged($event)\" previousText=\"&lsaquo;\" nextText=\"&rsaquo;\" firstText=\"&laquo;\" lastText=\"&raquo;\"\n  >\n\n</pagination>\n</div>"
...
var ListsComponent = /** @class */ (function () {
    function ListsComponent(authService, userService, alertifyService, route) {
        this.authService = authService;
        this.userService = userService;
        this.alertifyService = alertifyService;
        this.route = route;
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent.prototype.sendLike2 = function (id, receipentId) {
        var _this = this;
        this.userService.sendLike(id, receipentId).subscribe(function (resp) {
            console.log('user with id: ' + receipentId + 'is liked by : ' + id);
            _this.alertifyService.success('user with id: ' + receipentId + 'is liked by : ' + id);
        }, function (error) { return _this.alertifyService.error(error); });
    };
    MemberCardComponent.prototype.sendLike = function (id) {
        var _this = this;
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function (resp) {
            _this.alertifyService.success('you have liked ' + _this.user.knownAs);
        }, function (error) { return _this.alertifyService.error(error); });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
...
var MemberDetailComponent = /** @class */ (function () {
    function MemberDetailComponent(userService, alertifier, router) {
        this.userService = userService;
        this.alertifier = alertifier;
        this.router = router;
    }
...
var MemberMessagesComponent = /** @class */ (function () {
    ...
    ], MemberMessagesComponent.prototype, "receiverId", void 0);
...
var MessagesComponent = /** @class */ (function () {
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        var _this = this;
        this.alertifyService.confirm('sure to delete?', function () {
            _this.userService.deleteMessage(id, _this.authService.decodedToken.nameid).subscribe(function () {
                ...
                _this.alertifyService.success('Message has been deleted');
            }, function (error) {
                _this.alertifyService.error('Failed to delete the message');
            });
        });
    };
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(authService, alertifier, fb, router) {
        this.authService = authService;
        this.alertifier = alertifier;
        this.fb = fb;
        this.router = router;
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authService.register(this.user).subscribe(function () {
                _this.alertifier.success('Registered Successfully');
            }, function (error) {
                _this.alertifier.error(error);
            }, function () {
...
/* harmony import */ var _resolvers_message_resolver__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./_resolvers/message.resolver */ "./src/app/_resolvers/message.resolver.ts");
...
var appRoutes = [
    { path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_0__["HomeComponent"] },
    {
        ...
        children: [
            ...
            { path: 'messages', component: _messages_messages_component__WEBPACK_IMPORTED_MODULE_2__["MessagesComponent"], resolve: { messages: _resolvers_message_resolver__WEBPACK_IMPORTED_MODULE_12__["MessageResolver"] } },
...
module.exports = __webpack_require__(/*! C:\Source\CoreApplicationTest\CoreApplicationTest.UI\src\main.ts */"./src/main.ts");
